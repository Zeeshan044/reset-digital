        ...
        <div className=" gap-24 flex">
          <div className=" flex flex-col pl-14 pt-32 pb-28">
            <div className="w-[630px] gap-2 mb-20">
              <h5 className=" font-bold text-lg text-primary-dark montserrat mb-2">
                Beautiful
              </h5>
              <h2 className=" font-bold text-5xl mb-3">
                Web Design &
                <span className=" text-primary-dark pr-2">Development</span>{" "}
              </h2>
              <p className=" text-xl font-medium dark:text-primary-grey pr-28">
