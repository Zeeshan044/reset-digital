    ...
    <div className=" container-small pb-[112px]">
      <div className=" text-secondary-cold dark:text-primary-grey font-light flex gap-[102px] justify-between mb-12">
        <div className=" w-[397px]">
          <h5 className="text-xs font-light tracking-widest text-secondary-cold dark:text-secondary-light">
            GET TO KNOW
          </h5>
        ...
        <div>
          <h2 className="text-6xl font-medium pr-20 text-secondary-cold dark:text-secondary-light">
