    ...
    return (
        <div className="container-small  dark:text-white">
            <div className="flex justify-between mb-[80px]">
                <h2 className="text-6xl font-medium mt-14">Our <i className="text-primary-dark font-thin">Values</i></h2>
                <div className="font-light w-[331px] text-secondary-cold dark:text-secondary-light">
                    ...
                    <p className="text-base mt-4 dark:text-primary-grey">The client is paramount, and we prioritize dedicated support for our clients. Welcome to the forefront of exceptional service at Reset Digital.</p>
                </div>
            </div>
