...
const StartProject = () => {
  return (
    <div className="max-w-6xl mx-auto py-24 text-body">
      <div className="bg-card-dark pl-40 py-[90px] rounded-[30px] flex flex-col items-start relative overflow-hidden">
        <div className="flex flex-col items-center">
          ...
          <Link
            href="/contact"
            className="bg-primary-dark py-3 px-6 rounded-full mt-8 text-body-dark"
          >
            Get In Touch
          </Link>
        </div>
